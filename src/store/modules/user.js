...
const user = {
  ...
  actions: {
    ...
    async FetchPermission({ commit, state }) {
      let res = { "result": [{ "title": "工作台", "childs": [] }, { "title": "大数据展示", "childs": [] }, { "title": "管理", "childs": [{ "title": "组织架构单元", "childs": [] }, { "title": "角色", "childs": [] }, { "title": "用户", "childs": [] }, { "title": "语言列表", "childs": [] }, { "title": "审计日志", "childs": [] }, { "title": "维护", "childs": [] }] }, { "title": "基础数据", "childs": [{ "title": "字典数据", "childs": [] }, { "title": "区域", "childs": [] }, { "title": "上报单位", "childs": [] }] }, { "title": "设备管理", "childs": [{ "title": "设备列表", "childs": [] }] }, { "title": "区域管理", "childs": [{ "title": "区域列表", "childs": [] },{ "title": "区域管理员", "childs": [] }] }, { "title": "人员管理", "childs": [{ "title": "人员列表", "childs": [] },{ "title": "人员定位", "childs": [] },{ "title": "行为轨迹", "childs": [] }] }, { "title": "业务管理", "childs": [{ "title": "警报", "childs": [] }, { "title": "请假管理", "childs": [] },{ "title": "面谈记录", "childs": [] },{ "title": "教育学习", "childs": [] }, { "title": "社区服务", "childs": [] }] }, { "title": "地理围栏管理", "childs": [{ "title": "创建围栏", "childs": [] }, { "title": "围栏列表", "childs": [] }] }, { "title": "意见反馈", "childs": [] },], "targetUrl": null, "success": true, "error": null, "unAuthorizedRequest": false, "__abp": true }
